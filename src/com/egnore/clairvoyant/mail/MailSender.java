package com.egnore.clairvoyant.mail;
...
/**  
  ...
  */  
  ...
  return false;  
	...
	public void sendDefaultMail(String address, String subject, String content) {
		MailInfo mi = new MailInfo();
		mi.setToDefaultSender();
		mi.setSubject(subject);
		mi.setContent(content);
		mi.setToAddress(address);
		sendTextMail(mi);
	}
	public void test() {
		sendDefaultMail("chenbiao@hotmail.com", "test", "xxxx");
	}
}  
